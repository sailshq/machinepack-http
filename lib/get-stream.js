module.exports = {
  ...
  fn: function (inputs,exits) {
    ...
    mikealStream.on('error', function noop (err) { /*… no-op …*/ });//œ
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // FUTURE: Maybe re-examine the PassThrough thing, if it comes up.
    // (see 4f9c0a19ff012f591904811800a287eb13e7b8cf in this repo for more info)
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

    mikealStream.once('response', function() {
      alreadyExited = 'success';
      // ^^ is it actually "success"?  It could be a 404, for example.
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      // knowing about requestFailed.~~ UPDATE: the requestFailed thing is fixed now, afaik,
      // thanks to using the "response" event.)
      //
      ...
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      return exits.success(mikealStream);
    });//œ
