module.exports = {
  ...
  fn: function (inputs,exits) {
    ...
    mikealStream.once('response', function(mikealResponseInfo) {
      console.log('mikeal stream emitted "response" event', mikealResponseInfo);

      // TODO: test this non200Response stuff - no idea if it works!!!
      ...
      // > for more background and historical info on this feature.
      if (mikealResponseInfo.statusCode.statusCode >= 300 || mikealResponseInfo.statusCode.statusCode <= 199) {
        alreadyExited = 'non200Response';
        return exits.non200Response({
          statusCode: mikealResponseInfo.statusCode,
          headers: mikealResponseInfo.headers || {},
          body: mikealResponseInfo.body || ''
        });
      }//•
